...
#include "GpuSonar.hh"
//#include "gazebo/rendering/GpuSonarPrivate.hh"
#include "GpuSonarPrivate.hh"

using namespace gazebo;
using namespace rendering;

int GpuSonarPrivate::texCount = 0;

//////////////////////////////////////////////////
GpuSonar::GpuSonar(const std::string &_namePrefix, ScenePtr _scene,
                   const bool _autoRender)
: Camera(_namePrefix, _scene, _autoRender),
  dataPtr(new GpuSonarPrivate)
{
  this->dataPtr->sonarBuffer = NULL;
  this->dataPtr->sonarScan = NULL;
...
//////////////////////////////////////////////////
void GpuSonar::Load(sdf::ElementPtr _sdf)
{
  Camera::Load(_sdf);
}
...
void GpuSonar::Fini()
{
  ...
  delete [] this->dataPtr->sonarBuffer;
  this->dataPtr->sonarBuffer = nullptr;
  delete [] this->dataPtr->sonarScan;
  this->dataPtr->sonarScan = nullptr;

  Camera::Fini();
}

//////////////////////////////////////////////////
void GpuSonar::CreateSonarTexture(const std::string &_textureName)
{
  ...
  Ogre::MaterialManager::getSingleton().getByName("Gazebo/SonarScan1st").get());
  ...
  Ogre::MaterialManager::getSingleton().getByName("Gazebo/SonarScan2nd").get());
  ...
  for (unsigned int i = 0; i < this->dataPtr->textureCount; ++i)
  {
    ...
    GZ_ASSERT(technique, "GpuSonar material script error: technique not found");

    Ogre::Pass *pass = technique->getPass(0);
    GZ_ASSERT(pass, "GpuSonar material script error: pass not found");
...
void GpuSonar::PostRender()
{
  ...
  if (this->newData && this->captureData)
  {
    ...
    if (!this->dataPtr->sonarBuffer)
      this->dataPtr->sonarBuffer = new float[size];

    memset(this->dataPtr->sonarBuffer, 255, size);

    Ogre::PixelBox dstBox(width, height,
        1, Ogre::PF_FLOAT32_RGB, this->dataPtr->sonarBuffer);

    pixelBuffer->blitToMemory(dstBox);

    if (!this->dataPtr->sonarScan)
    {
      int len = this->dataPtr->w2nd * this->dataPtr->h2nd * 3;
      this->dataPtr->sonarScan = new float[len];
    }

    memcpy(this->dataPtr->sonarScan, this->dataPtr->sonarBuffer,
           this->dataPtr->w2nd * this->dataPtr->h2nd * 3 *
           sizeof(this->dataPtr->sonarScan[0]));

    this->dataPtr->newSonarFrame(this->dataPtr->sonarScan, this->dataPtr->w2nd,
...
/////////////////////////////////////////////////
void GpuSonar::UpdateRenderTarget(Ogre::RenderTarget *_target,
...
/////////////////////////////////////////////////
void GpuSonar::notifyRenderSingleObject(Ogre::Renderable *_rend,
...
//////////////////////////////////////////////////
const float* GpuSonar::SonarData() const
{
  return this->dataPtr->sonarBuffer;
}

//////////////////////////////////////////////////
GpuSonar::DataIter GpuSonar::SonarDataBegin() const
{
  ...
  return DataIter(index, this->dataPtr->sonarBuffer, skip, rangeOffset,
      intenOffset, this->dataPtr->w2nd);
}

//////////////////////////////////////////////////
GpuSonar::DataIter GpuSonar::SonarDataEnd() const
{
...
/////////////////////////////////////////////////
Ogre::Matrix4 GpuSonar::BuildScaledOrthoMatrix(const float _left,
...
//////////////////////////////////////////////////
void GpuSonar::Set1stPassTarget(Ogre::RenderTarget *_target,
...
//////////////////////////////////////////////////
void GpuSonar::Set2ndPassTarget(Ogre::RenderTarget *_target)
{
...
/////////////////////////////////////////////////
void GpuSonar::SetRangeCount(const unsigned int _w, const unsigned int _h)
{
...
void GpuSonar::CreateMesh()
{
  ...
  // see GpuSonar::Set2ndPassTarget() on how the ortho cam is set up
  double startX = dx;
  ...
  for (unsigned int j = 0; j < this->dataPtr->h2nd; ++j)
  {
    ...
    {
      // current horizontal angle from start of sonar scan
      ...
      // the texture/1000.0 value is used in the sonar_2nd_pass.frag shader
      ...
      // sonar ray the depth image plane.
...
//////////////////////////////////////////////////
void GpuSonar::SetHorzHalfAngle(const double _angle)
{
  this->horzHalfAngle = _angle;
}

//////////////////////////////////////////////////
void GpuSonar::SetVertHalfAngle(const double _angle)
{
  this->vertHalfAngle = _angle;
}

//////////////////////////////////////////////////
double GpuSonar::HorzHalfAngle() const
{
  return this->horzHalfAngle;
}

//////////////////////////////////////////////////
double GpuSonar::VertHalfAngle() const
{
  return this->vertHalfAngle;
}

//////////////////////////////////////////////////
void GpuSonar::SetIsHorizontal(const bool _horizontal)
{
  this->isHorizontal = _horizontal;
}

//////////////////////////////////////////////////
bool GpuSonar::IsHorizontal() const
{
  return this->isHorizontal;
}

//////////////////////////////////////////////////
double GpuSonar::HorzFOV() const
{
  return this->hfov;
}

//////////////////////////////////////////////////
double GpuSonar::VertFOV() const
{
  return this->vfov;
}

//////////////////////////////////////////////////
void GpuSonar::SetHorzFOV(const double _hfov)
{
  this->hfov = _hfov;
}

//////////////////////////////////////////////////
void GpuSonar::SetVertFOV(const double _vfov)
{
  this->vfov = _vfov;
}

//////////////////////////////////////////////////
double GpuSonar::CosHorzFOV() const
{
  return this->chfov;
}

//////////////////////////////////////////////////
void GpuSonar::SetCosHorzFOV(const double _chfov)
{
  this->chfov = _chfov;
}

//////////////////////////////////////////////////
double GpuSonar::CosVertFOV() const
{
  return this->cvfov;
}

//////////////////////////////////////////////////
void GpuSonar::SetCosVertFOV(const double _cvfov)
{
  this->cvfov = _cvfov;
}

//////////////////////////////////////////////////
double GpuSonar::NearClip() const
{
  return this->nearClip;
}

//////////////////////////////////////////////////
double GpuSonar::FarClip() const
{
  return this->farClip;
}

//////////////////////////////////////////////////
void GpuSonar::SetNearClip(const double _near)
{
  this->nearClip = _near;
}

//////////////////////////////////////////////////
void GpuSonar::SetFarClip(const double _far)
{
  this->farClip = _far;
}

//////////////////////////////////////////////////
unsigned int GpuSonar::CameraCount() const
{
  return this->cameraCount;
}

//////////////////////////////////////////////////
void GpuSonar::SetCameraCount(const unsigned int _cameraCount)
{
  this->cameraCount = _cameraCount;
}

//////////////////////////////////////////////////
double GpuSonar::RayCountRatio() const
{
  return this->rayCountRatio;
}

//////////////////////////////////////////////////
void GpuSonar::SetRayCountRatio(const double _rayCountRatio)
{
  this->rayCountRatio = _rayCountRatio;
}

//////////////////////////////////////////////////
event::ConnectionPtr GpuSonar::ConnectNewSonarFrame(
    std::function<void (const float *_frame, unsigned int _width,
    unsigned int _height, unsigned int _depth,
    const std::string &_format)> _subscriber)
{
  return this->dataPtr->newSonarFrame.Connect(_subscriber);
}
